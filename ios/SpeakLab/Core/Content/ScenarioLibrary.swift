    ...
    private static let conversationScenarios: [Scenario] = [
        Scenario(
            ...
            character: CharacterBrief(
                ...
                personality: "Polite, a little guarded, answers briefly until she trusts you. Warms up fast if you notice something specific about her child.",
                ...
                objection: "Says she's 'just looking at a few options at the moment' — a soft brush-off she'll drop if she feels heard.",
        ...
        Scenario(
            ...
            character: CharacterBrief(
                ...
                objection: "Deflects with 'we'll see how it goes'.",
        ...
        Scenario(
            ...
            character: CharacterBrief(
                ...
                personality: "Guarded, monosyllabic when self-conscious, funny once relaxed. Watches closely for any hint of a telling-off.",
                ...
                objection: "Deflects with \"yeah, been busy\".",
        ...
        Scenario(
            ...
            character: CharacterBrief(
                name: "Jo",
                role: "Parent, curious",
                personality: "Friendly, chatty, easy to talk to, no agenda.",
